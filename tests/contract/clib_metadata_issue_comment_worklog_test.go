...
func TestIssueCommentAndWorklogFlagsPublishClibMetadata(t *testing.T) {
	...
	for _, want := range []issueCommentWorklogMetadataWant{
		...
		{commandPath: "jira issue list", flagName: "--columns", group: "Output", placeholder: "COLS", enumContains: []string{"key", "summary", "status", "assignee", "priority", "created", "updated"}, enumTerse: []string{"issue key", "title text", "workflow status", "assigned user", "priority level", "creation time", "last-updated time"}},
		{commandPath: "jira issue mine", flagName: "--columns", group: "Output", placeholder: "COLS", enumContains: []string{"key", "summary", "status", "assignee", "priority", "created", "updated"}, enumTerse: []string{"issue key", "title text", "workflow status", "assigned user", "priority level", "creation time", "last-updated time"}},
		...
		{commandPath: "jira issue transition", flagName: "--transition", group: "Transition", placeholder: "STATUS", completion: "predictor=cachestatus"},
		...
		{commandPath: "jira issue comment", flagName: "--markdown", group: "Input", placeholder: "MARKDOWN"},
		...
		{commandPath: "jira issue comment add", flagName: "--markdown", group: "Input", placeholder: "MARKDOWN"},
		...
		{commandPath: "jira issue comment edit", flagName: "--markdown", group: "Input", placeholder: "MARKDOWN"},
		...
		{commandPath: "jira worklog add", flagName: "--markdown", group: "Input", placeholder: "MARKDOWN"},
