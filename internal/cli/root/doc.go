...
// a command whose result could not be written. It also recovers destination
// failures from Cobra's void help callback and command-scoped Clog diagnostics.
// Dynamic completion candidates use the root writer; Clib's upstream
// --print-completion flag remains the one deliberate process-stdout boundary.
// It is the composition root every command package registers into.
package root
